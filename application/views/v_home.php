...
<body>
      ...
      <div class="container">
        ...
        <div class="row" data-aos="zoom-in">
          ...
          <div class="col-lg-2 col-md-4 col-6 d-flex align-items-center justify-content-center">
            <img src="<?php echo base_url('Arsha/assets/img/clients/client-1.png');?>" class="img-fluid" alt="">
          </div>

          <div class="col-lg-2 col-md-4 col-6 d-flex align-items-center justify-content-center">
            <img src="<?php echo base_url('Arsha/assets/img/clients/client-2.png');?>" class="img-fluid" alt="">
          </div>

          <div class="col-lg-2 col-md-4 col-6 d-flex align-items-center justify-content-center">
            <img src="<?php echo base_url('Arsha/assets/img/clients/client-3.png');?>" class="img-fluid" alt="">
          </div>

          <div class="col-lg-2 col-md-4 col-6 d-flex align-items-center justify-content-center">
            <img src="<?php echo base_url('Arsha/assets/img/clients/client-4.png');?>" class="img-fluid" alt="">
          </div>
  ...
  <!-- Vendor JS Files -->
  <script src="<?php echo base_url('Arsha/assets/vendor/aos/aos.js');?>"></script>
  <script src="<?php echo base_url('Arsha/assets/vendor/bootstrap/js/bootstrap.bundle.min.js');?>"></script>
  <script src="<?php echo base_url('Arsha/assets/vendor/glightbox/js/glightbox.min.js');?>"></script>
  <script src="<?php echo base_url('Arsha/assets/vendor/isotope-layout/isotope.pkgd.min.js');?>"></script>
  <script src="<?php echo base_url('Arsha/assets/vendor/php-email-form/validate.js');?>"></script>
  <script src="<?php echo base_url('Arsha/assets/vendor/swiper/swiper-bundle.min.js');?>"></script>
  <script src="<?php echo base_url('Arsha/assets/vendor/waypoints/noframework.waypoints.js');?>"></script>

  <!-- Template Main JS File -->
  <script src="<?php echo base_url('Arsha/assets/js/main.js');?>"></script>
